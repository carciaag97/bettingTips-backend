...
using iSoft.FLEETMANAGEMENT.Backend.Infrastructure.Config.ConfigModels;
using Microsoft.Extensions.Configuration;

namespace iSoft.FLEETMANAGEMENT.Backend.Infrastructure.Config
{
    public static class AppConfig
    {
        ...
        public static void MigrationsInit()
        {
            ...
            var builder = new ConfigurationBuilder()
                .SetBasePath($"{Directory.GetCurrentDirectory()}/../iSoft.FLEETMANAGEMENT/")
